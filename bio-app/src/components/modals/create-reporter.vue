  ...
  <div class="modal-inner">
    <div class="modal-header">
      <div class="model-header__left">
        <div class="modal-title">Add Reporter</div>
      </div>
    ...
    <div class="modal-body">
      <div class="form1">
        ...
        <div class="form-group">
          ...
          <div class="form-input-box"><input class="form-input" v-model="f.protein"></div>
          <div class="form-err">
    ...
    <div class="modal-footer">
      <div class="form-buttons">
        ...
        <a class="btn btn-primary" :class="{ disabled: busying }" @click="save()">Save</a>
      </div>
    </div>
  </div>
</template>
    ...
    async save() {
      ...
      try {
        const task = await submitTproTask({
          operation: 'reporter/register',
          name: buildTaskName('Creating reporter'),
